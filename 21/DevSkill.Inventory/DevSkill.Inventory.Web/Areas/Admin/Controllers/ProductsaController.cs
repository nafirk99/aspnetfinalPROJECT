...
namespace DevSkill.Inventory.Web.Areas.Admin.Controllers
{
    ...
    public class ProductsaController : Controller
    {
        ...
        public ProductsaController(InventoryDbContext context, IWebHostEnvironment environment, ConcurrentQueue<string> imageQueue)
        {
            _context = context;
        ...
        public IActionResult Create(ProductDTO productDTO)
        {
            ...
            _imageQueue.Enqueue(imageFullPath);
